...
| `→` | Open the selected category (empty query only; apps and typed text keep caret duty) |
| `Esc` | Close from a fresh category prime or an empty query; otherwise clear the query first (and cancel any picker request) |
