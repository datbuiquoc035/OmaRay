...
function resolve(route) {
  ...
  // The Applications view is the idle palette: most-used apps first.
  if (r === "apps") return { kind: "open" }
  // Power rows are three keystrokes away; a primed query would only bias
  // toward one of lock/logout/reboot/shutdown and hide the rest.
  if (r === "system") return { kind: "open" }
