...
function commands() {
  return [
    ...
    { key: "theme.bg",    title: "Change Background",        subtitle: "Open the wallpaper picker",   icon: "󰸉", kind: "shell", argv: ["omarchy", "theme", "bg-switcher"],    keywords: "wallpaper background image desktop theme" },
